...
(function (global, factory) {
	...
	var responsiveBackgroundImages_minExports = {};
	var responsiveBackgroundImages_min = {
	  get exports(){ return responsiveBackgroundImages_minExports; },
	  set exports(v){ responsiveBackgroundImages_minExports = v; },
	};
	...
	(function (module, exports) {
		!function (e, t) {
		  ...
		  var t = {},
		    ...
		    n = [],
		    i = function (e, t, r) {
		      if ("[object Object]" === Object.prototype.toString.call(e)) for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && t.call(r, e[n], n, e);else for (var i = 0, o = e.length; o > i; i++) t.call(r, e[i], i, e);
		    },
		    o = function (e, t) {
		      var r = {};
		      ...
		      var n,
		        ...
		        l = function () {
		          var u = new Date().getTime(),
		            f = u - a;
		          t > f && f >= 0 ? n = setTimeout(l, t - f) : (n = null, r || (c = e.apply(o, i), n || (o = i = null)));
		        };
		      return function () {
		        o = this, i = arguments, a = new Date().getTime();
		        var u = r && !n;
		        return n || (n = setTimeout(l, t)), u && (c = e.apply(o, i), o = i = null), c;
		      };
		    };
		  return t.run = function (e) {
		    r = o(r, e || {});
		    for (var i, a, c, l = document.querySelectorAll("[data-" + r.selector + "]"), u = 0, f = l.length; f > u; u++) {
		      var s = [];
		      if (i = l[u], a = i.getAttribute("data-" + r.selector), c = i.offsetWidth * window.devicePixelRatio || 1, s = t.parseSrcSet(a), s.length > 0) for (var d = 0, g = s.length; g > d; d++) if (s[d].width >= c || d === g - 1) {
		        var v = null;
		        s[d].force || (v = t.findAlreadyLoadedBiggerImage(s, c));
		        var h = v ? v : s[d].src;
		        i.style.backgroundImage = "url('" + h + "')", -1 === n.indexOf(h) && n.push(h);
		        break;
		      }
		    }
		  }, t.parseSrcSet = function (e) {
		    var t = [];
		    if (null !== e && e.length > 0) {
		      for (var r = e.split(","), n = 0, i = r.length; i > n; n++) {
		        var o = r[n].match(/(\S+)\s+(\d+)w(\s+force)?/);
		        t.push({
		          src: o[1],
		          width: o[2],
		          force: !!o[3]
		    ...
		    return t;
		  }, t.findAlreadyLoadedBiggerImage = function (e, t) {
		    for (var r = e.slice(0).reverse(), i = 0, o = r.length; o > i; i++) if (-1 !== n.indexOf(r[i].src) && (r[i].width >= t || 0 === i)) return r[i].src;
		    return null;
		  }, t.addResizeEvent = function () {
		    window.addEventListener("resize", a(t.run, r.interval));
		  }, t.run(), t.addResizeEvent(), t;
		});
	} (responsiveBackgroundImages_min));
		...
		(function (factory) {
		  ...
		  Datepicker.prototype = {
		    ...
		    getFormattedDate: function (format) {
		      if (format === undefined$1) format = this.o.format;
		    ...
		    fill: function () {
		      ...
		      while (prevMonth.valueOf() < nextMonth) {
		        ...
		        if (this.o.beforeShowDay !== $.noop) {
		          ...
		          if (before === undefined$1) before = {};else if (typeof before === 'boolean') before = {
		            enabled: before
		  ...
		  var datepickerPlugin = function (option) {
		    ...
		    if (internal_return === undefined$1 || internal_return instanceof Datepicker || internal_return instanceof DateRangePicker) return this;
	...
	(function ($) {
	  $.fn.prettyBreak = function () {
	    return this.each(function () {
	      const element = $(this);
	      if (element.hasClass('pretty-done')) {
	        return;
	      }
	      ...
	      if (textWidth / 2 > element.parent().innerWidth() || textWidth > 2 * element.parent().innerWidth()) {
	        return;
	      }
